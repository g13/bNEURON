fclose('all');
picformat = '';
%theme = 'stem-L13-dend-I-r32-3';
theme = 'bctive-sub-2'
type = 'RS_exc_Rat';
ith = 1;
sizeofsize = 'int64';
%libfile = 'L9dt-Stem-spike-m-n-NEURON.mat';
%libfile = 'L9dt-mStem-NEURON.mat';
%libfile = 'L9dt-mdend-Na-NEURON.mat'; % actually no Na
libfile = 'mpiTest-mctive-NEURON.mat';
cutoff = true;
rE = 20; % Hz
rI = 40;
seed = 193864;
